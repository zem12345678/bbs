...
import (
	"feed-service/internal/ioc/discovery"
	"feed-service/internal/ioc/trace"
	"feed-service/pkg/grpc/middleware/recovery"
	"feed-service/pkg/logger"
	"feed-service/pkg/network"
	"fmt"
	"net"
	"os"
	"os/signal"
...
func NewServerOptions(v *viper.Viper, l logger.Logger) (*ServerOptions, error) {
	...
	normalizeServerOptions(&o, v, "bbs-feed-service", "feed-service")
