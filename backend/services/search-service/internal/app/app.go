...
import (
	"search-service/internal/ioc/application"
	"search-service/internal/ioc/grpc"
...
func NewOptions(v *viper.Viper, logger *zap.Logger) (*Options, error) {
	...
	if o.Name == "" {
		o.Name = StringDefault(v.GetString("grpc.server.serviceName"), StringDefault(v.GetString("service.name"), "bbs-search-service"))
	}
