...
import (
	...
	"os"
	"os/signal"
	"search-service/internal/ioc/discovery"
	"search-service/internal/ioc/trace"
	"search-service/pkg/grpc/middleware/recovery"
	"search-service/pkg/logger"
	"search-service/pkg/network"
	"strings"
	"syscall"
	"time"
...
func NewServerOptions(v *viper.Viper, l logger.Logger) (*ServerOptions, error) {
	...
	normalizeServerOptions(&o, v, "bbs-search-service", "search-service")
