...
func TestResolverBuildCreatesIndependentConnectionState(t *testing.T) {
	...
	second, err := builder.Build(resolver.Target{URL: url.URL{Path: "/notification/1.0.0"}}, secondConn, resolver.BuildOptions{})
	if err != nil {
	...
	if firstResolver.keyPrefix != "/mall/1.0.0/" || secondResolver.keyPrefix != "/notification/1.0.0/" {
