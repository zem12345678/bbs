...
func requiresInternalAuthentication(fullMethod string) bool {
	// Health Check is deliberately unauthenticated so discovery and load
	// balancers can determine liveness. Every other RPC, including Health
	// Watch, is an internal service operation and requires the shared token.
