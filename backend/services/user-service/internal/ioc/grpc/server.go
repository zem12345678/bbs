...
import (
	...
	"syscall"
	"time"
	"user-service/internal/ioc/discovery"
	"user-service/internal/ioc/trace"
	"user-service/pkg/grpc/middleware/recovery"
	"user-service/pkg/logger"
	"user-service/pkg/network"
...
func NewServerOptions(v *viper.Viper, l logger.Logger) (*ServerOptions, error) {
	...
	normalizeServerOptions(&o, v, "bbs-user-service", "user-service")
