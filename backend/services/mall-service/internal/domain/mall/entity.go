...
var (
	...
	ErrUnsupportedThemeGrantKey     = errors.New("unsupported theme grant key")
	...
	ErrActiveBadgeEntitlementExists = errors.New("active badge entitlement already exists")
	ErrPendingBadgeOrderExists      = errors.New("pending badge order already exists")
	ErrDuplicateBadgeGrantInOrder   = errors.New("duplicate badge grant in order")
	ErrProductCategoryNotFound      = errors.New("product category not found")
	ErrProductCategoryUnavailable   = errors.New("product category unavailable")
	ErrProductCategoryLocked        = errors.New("product category cannot be disabled while active products exist")
...
type Repository interface {
	...
	BeginOrderPayment(ctx context.Context, orderID, userID int64, paymentMethod, idempotencyKey string, expireBefore, startedAt time.Time) (Order, Payment, error)
