...
func toStatusError(err error) error {
	...
	case errors.Is(err, domain.ErrProductUnavailable), errors.Is(err, domain.ErrProductGrantLocked), errors.Is(err, domain.ErrProductFulfillmentLocked), errors.Is(err, domain.ErrInvalidOrderState), errors.Is(err, domain.ErrInsufficientStock), errors.Is(err, domain.ErrInsufficientCredits), errors.Is(err, domain.ErrUnsupportedPayment), errors.Is(err, domain.ErrCouponUnavailable), errors.Is(err, domain.ErrCouponTermsLocked), errors.Is(err, domain.ErrMembershipRefundUnavailable), errors.Is(err, domain.ErrPendingMembershipOrderExists), errors.Is(err, domain.ErrActiveThemeEntitlementExists), errors.Is(err, domain.ErrPendingThemeOrderExists), errors.Is(err, domain.ErrDuplicateThemeGrantInOrder), errors.Is(err, domain.ErrActiveBadgeEntitlementExists), errors.Is(err, domain.ErrPendingBadgeOrderExists), errors.Is(err, domain.ErrDuplicateBadgeGrantInOrder):
