...
import (
	"fmt"
	"mall-service/internal/ioc/discovery"
	"mall-service/internal/ioc/trace"
	"mall-service/pkg/grpc/middleware/recovery"
	"mall-service/pkg/logger"
	"mall-service/pkg/network"
	"net"
	"os"
	"os/signal"
	"syscall"
...
func NewServerOptions(v *viper.Viper, l logger.Logger) (*ServerOptions, error) {
	...
	normalizeServerOptions(&o, v, "bbs-mall-service", "mall-service")
