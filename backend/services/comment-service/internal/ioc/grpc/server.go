...
import (
	"comment-service/internal/ioc/discovery"
	"comment-service/internal/ioc/trace"
	"comment-service/pkg/grpc/middleware/recovery"
	"comment-service/pkg/logger"
	"comment-service/pkg/network"
	"fmt"
	"net"
	"os"
	"os/signal"
...
func NewServerOptions(v *viper.Viper, l logger.Logger) (*ServerOptions, error) {
	...
	normalizeServerOptions(&o, v, "bbs-comment-service", "comment-service")
