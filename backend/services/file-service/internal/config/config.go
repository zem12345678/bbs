...
func configureEnv(v *viper.Viper) {
	...
	for key, aliases := range map[string][]string{
		...
		"storage.endpoint":                   {"BBS_FILE_STORAGE_ENDPOINT"},
		"storage.bucket":                     {"BBS_FILE_STORAGE_BUCKET"},
		"storage.accessKey":                  {"BBS_FILE_STORAGE_ACCESS_KEY"},
		"storage.secretKey":                  {"BBS_FILE_STORAGE_SECRET_KEY"},
