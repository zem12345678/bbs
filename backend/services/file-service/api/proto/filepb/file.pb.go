...
const file_api_proto_file_proto_rawDesc = "" +
	...
	"\bowner_id\x18\x02 \x01(\x03R\aownerId2\xa8\x03\n" +
	"\vFileService\x12Y\n" +
	"\x10CreateAttachment\x12$.bbs.file.v1.CreateAttachmentRequest\x1a\x1f.bbs.file.v1.AttachmentResponse\x12e\n" +
...
var file_api_proto_file_proto_goTypes = []any{
	...
	(*ListTopicAttachmentsRequest)(nil),        // 3: bbs.file.v1.ListTopicAttachmentsRequest
	(*AttachmentListResponse)(nil),             // 4: bbs.file.v1.AttachmentListResponse
	(*AuthorizeAttachmentDownloadRequest)(nil), // 5: bbs.file.v1.AuthorizeAttachmentDownloadRequest
	(*DownloadAuthorizationResponse)(nil),      // 6: bbs.file.v1.DownloadAuthorizationResponse
	(*ArchiveAttachmentRequest)(nil),           // 7: bbs.file.v1.ArchiveAttachmentRequest
}
var file_api_proto_file_proto_depIdxs = []int32{
	...
	3, // 4: bbs.file.v1.FileService.ListTopicAttachments:input_type -> bbs.file.v1.ListTopicAttachmentsRequest
	5, // 5: bbs.file.v1.FileService.AuthorizeAttachmentDownload:input_type -> bbs.file.v1.AuthorizeAttachmentDownloadRequest
	7, // 6: bbs.file.v1.FileService.ArchiveAttachment:input_type -> bbs.file.v1.ArchiveAttachmentRequest
	2, // 7: bbs.file.v1.FileService.CreateAttachment:output_type -> bbs.file.v1.AttachmentResponse
	4, // 8: bbs.file.v1.FileService.ListTopicAttachments:output_type -> bbs.file.v1.AttachmentListResponse
	6, // 9: bbs.file.v1.FileService.AuthorizeAttachmentDownload:output_type -> bbs.file.v1.DownloadAuthorizationResponse
	2, // 10: bbs.file.v1.FileService.ArchiveAttachment:output_type -> bbs.file.v1.AttachmentResponse
