...
const file_api_proto_file_proto_rawDesc = "" +
	...
	"\x0fdeleted_objects\x18\x04 \x01(\x03R\x0edeletedObjects2\x9a\n" +
	"\n" +
	"\vFileService\x12Y\n" +
...
var file_api_proto_file_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_api_proto_file_proto_goTypes = []any{
	...
	(*EraseUserDataRequest)(nil),               // 25: bbs.file.v1.EraseUserDataRequest
	(*EraseUserDataResponse)(nil),              // 26: bbs.file.v1.EraseUserDataResponse
}
var file_api_proto_file_proto_depIdxs = []int32{
	...
	25, // 22: bbs.file.v1.FileService.EraseUserData:input_type -> bbs.file.v1.EraseUserDataRequest
	...
	18, // 34: bbs.file.v1.FileService.GetFile:output_type -> bbs.file.v1.FileResponse
	18, // 35: bbs.file.v1.FileService.DeleteFile:output_type -> bbs.file.v1.FileResponse
	26, // 36: bbs.file.v1.FileService.EraseUserData:output_type -> bbs.file.v1.EraseUserDataResponse
