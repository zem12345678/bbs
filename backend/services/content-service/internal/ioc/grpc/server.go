...
import (
	"content-service/internal/ioc/discovery"
	"content-service/internal/ioc/trace"
	"content-service/pkg/grpc/middleware/recovery"
	"content-service/pkg/logger"
	"content-service/pkg/network"
	"fmt"
	"net"
	"os"
	"os/signal"
...
func NewServerOptions(v *viper.Viper, l logger.Logger) (*ServerOptions, error) {
	...
	normalizeServerOptions(&o, v, "bbs-content-service", "content-service")
