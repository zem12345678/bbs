...
const file_mall_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"mall.proto\x12\vbbs.mall.v1\"\x91\x04\n" +
	...
	"\vMallService\x12|\n" +
	"\x1bListUserDigitalEntitlements\x12/.bbs.mall.v1.ListUserDigitalEntitlementsRequest\x1a,.bbs.mall.v1.ListDigitalEntitlementsResponseB)Z'content-service/api/proto/mallpb;mallpbb\x06proto3"
