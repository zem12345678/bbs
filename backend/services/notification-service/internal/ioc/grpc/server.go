...
import (
	"fmt"
	"net"
	"notification-service/internal/ioc/discovery"
	"notification-service/internal/ioc/trace"
	"notification-service/pkg/grpc/middleware/recovery"
	"notification-service/pkg/logger"
	"notification-service/pkg/network"
	"os"
	"os/signal"
	"syscall"
	"time"
...
func NewServerOptions(v *viper.Viper, l logger.Logger) (*ServerOptions, error) {
	...
	normalizeServerOptions(&o, v, "bbs-notification-service", "notification-service")
