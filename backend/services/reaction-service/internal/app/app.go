...
import (
	...
	"reaction-service/internal/ioc/grpc"
...
func NewOptions(v *viper.Viper, logger *zap.Logger) (*Options, error) {
	...
	if strings.TrimSpace(o.Name) == "" {
		o.Name = StringDefault(v.GetString("grpc.server.serviceName"), StringDefault(v.GetString("service.name"), "bbs-reaction-service"))
	}
