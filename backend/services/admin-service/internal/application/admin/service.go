...
type ContentGateway interface {
	...
	ListChannels(ctx context.Context, query string, categoryID int64, archivedStatus int32, limit int32, offset int32) (domain.ChannelList, error)
	SetChannelFeatured(ctx context.Context, id int64, featured bool) (domain.Channel, error)
	SetChannelArchived(ctx context.Context, id int64, archived bool) (domain.Channel, error)
