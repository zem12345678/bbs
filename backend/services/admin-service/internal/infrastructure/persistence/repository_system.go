...
func seedDefaultSystemManagement(ctx context.Context, tx *gorm.DB) error {
	...
	governanceChildren := []po.Menu{
		...
		{Name: "governance.links", Title: "友情链接", Icon: "ri/links-line", Path: "/governance/links", Paths: "/governance/links", Type: "C", Permission: governancePermission(domain.ActionListLinks), ParentId: governanceRoot.ID, Status: "0", Visible: "0", IsHide: "0", Component: "governance/links/index", Sort: 1080, Remark: "bootstrap governance links"},
		{Name: "governance.tasks", Title: "任务管理", Icon: "ri/task-line", Path: "/governance/tasks", Paths: "/governance/tasks", Type: "C", Permission: governancePermission(domain.ActionListTasks), ParentId: governanceRoot.ID, Status: "0", Visible: "0", IsHide: "0", Component: "governance/tasks/index", Sort: 1090, Remark: "bootstrap governance tasks"},
		{Name: "governance.badges", Title: "徽章管理", Icon: "ri/medal-line", Path: "/governance/badges", Paths: "/governance/badges", Type: "C", Permission: governancePermission(domain.ActionListBadges), ParentId: governanceRoot.ID, Status: "0", Visible: "0", IsHide: "0", Component: "governance/badges/index", Sort: 1100, Remark: "bootstrap governance badges"},
		{Name: "governance.levels", Title: "等级管理", Icon: "ri/vip-crown-line", Path: "/governance/levels", Paths: "/governance/levels", Type: "C", Permission: governancePermission(domain.ActionListLevels), ParentId: governanceRoot.ID, Status: "0", Visible: "0", IsHide: "0", Component: "governance/levels/index", Sort: 1110, Remark: "bootstrap governance levels"},
	}
