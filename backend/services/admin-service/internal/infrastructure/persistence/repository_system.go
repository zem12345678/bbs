...
func seedDefaultSystemManagement(ctx context.Context, tx *gorm.DB) error {
	...
	governanceChildren := []po.Menu{
		...
		{Name: "governance.channels", Title: "圈子管理", Icon: "ri/team-line", Path: "/governance/channels", Paths: "/governance/channels", Type: "C", Permission: governancePermission(domain.ActionListChannels), ParentId: governanceRoot.ID, Status: "0", Visible: "0", IsHide: "0", Component: "governance/channels/index", Sort: 1035, Remark: "bootstrap governance channels"},
		...
		{Name: "governance.comments", Title: "评论管理", Icon: "ri/chat-3-line", Path: "/governance/comments", Paths: "/governance/comments", Type: "C", Permission: governancePermission(domain.ActionListComments), ParentId: governanceRoot.ID, Status: "0", Visible: "0", IsHide: "0", Component: "governance/comments/index", Sort: 1050, Remark: "bootstrap governance comments"},
	...
	governanceButtonSeeds := map[string][]systemMenuButtonSeed{
		...
		"governance.channels": {
			{Name: "query", Title: "查询", Permission: governancePermission(domain.ActionListChannels), SortOffset: 1},
			{Name: "feature", Title: "精选", Permission: governancePermission(domain.ActionFeatureChannel), SortOffset: 2},
			{Name: "archive", Title: "归档", Permission: governancePermission(domain.ActionArchiveChannel), SortOffset: 3},
			{Name: "restore", Title: "恢复", Permission: governancePermission(domain.ActionRestoreChannel), SortOffset: 4},
		},
		"governance.categories": {
			{Name: "query", Title: "查询", Permission: governancePermission(domain.ActionListCategories), SortOffset: 1},
			{Name: "create", Title: "新增", Permission: governancePermission(domain.ActionCreateCategory), SortOffset: 2},
			{Name: "update", Title: "修改", Permission: governancePermission(domain.ActionUpdateCategory), SortOffset: 3},
			{Name: "delete", Title: "删除", Permission: governancePermission(domain.ActionDeleteCategory), SortOffset: 4},
		},
		"governance.comments": {
		...
		"governance.forbidden-words": {
			{Name: "query", Title: "查询", Permission: governancePermission(domain.ActionListForbiddenWords), SortOffset: 1},
			{Name: "create", Title: "新增", Permission: governancePermission(domain.ActionCreateForbiddenWord), SortOffset: 2},
		...
		"governance.tasks": {
			...
			{Name: "update", Title: "修改", Permission: governancePermission(domain.ActionUpdateTask), SortOffset: 3},
			{Name: "delete", Title: "删除", Permission: governancePermission(domain.ActionDeleteTask), SortOffset: 4},
		},
		"governance.badges": {
			{Name: "query", Title: "查询", Permission: governancePermission(domain.ActionListBadges), SortOffset: 1},
			{Name: "create", Title: "新增", Permission: governancePermission(domain.ActionCreateBadge), SortOffset: 2},
		...
		"governance.levels": {
			...
			{Name: "update", Title: "修改", Permission: governancePermission(domain.ActionUpdateLevel), SortOffset: 3},
			{Name: "delete", Title: "删除", Permission: governancePermission(domain.ActionDeleteLevel), SortOffset: 4},
		},
	}
	moderatorPermissions := map[string]struct{}{
		...
		governancePermission(domain.ActionListChannels):   {},
		governancePermission(domain.ActionFeatureChannel): {},
	...
	for i := range governanceChildren {
		...
		if _, adminOnly := adminOnlyGovernanceMenus[governanceChildren[i].Name]; !adminOnly {
	...
	mallChildren := []po.Menu{
		{Name: "mall.overview", Title: "商城概览", Icon: "ri/dashboard-3-line", Path: "/mall/overview", Paths: "/mall/overview", Type: "C", Permission: mallPermission(domain.ActionListMallOrders), ParentId: mallRoot.ID, Status: "0", Visible: "0", IsHide: "0", Component: "mall/overview/index", Sort: 1201, Remark: "bootstrap mall overview"},
