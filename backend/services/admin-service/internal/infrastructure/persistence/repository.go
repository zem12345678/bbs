...
func (r *Repository) SeedDefaults(ctx context.Context, bootstrapAdmins []string, defaultPassword string) error {
	...
	return r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		...
		rules := []po.CasbinRule{
			...
			policy("moderator", "governance", "publish_article"),
			policy("moderator", "governance", "hide_article"),
			policy("moderator", "governance", "list_topics"),
			policy("moderator", "governance", "publish_topic"),
			policy("moderator", "governance", "hide_topic"),
			policy("moderator", "governance", "list_comments"),
			policy("moderator", "governance", "hide_comment"),
			policy("moderator", "governance", "restore_comment"),
			policy("admin", "governance", "list_users"),
			policy("admin", "governance", "mute_user"),
			policy("admin", "governance", "unmute_user"),
			policy("admin", "governance", "archive_article"),
			policy("admin", "governance", "archive_topic"),
			policy("admin", "governance", "list_categories"),
			policy("admin", "governance", "create_category"),
			policy("admin", "governance", "update_category"),
			policy("admin", "governance", "delete_category"),
			policy("admin", "governance", "list_admin_users"),
			policy("admin", "governance", "create_admin_user"),
			policy("admin", "governance", "list_roles"),
			policy("admin", "governance", "assign_roles"),
			policy("admin", "governance", "list_badges"),
			policy("admin", "governance", "create_badge"),
			policy("admin", "governance", "update_badge"),
			policy("admin", "governance", "delete_badge"),
			policy("admin", "governance", "list_levels"),
			policy("admin", "governance", "create_level"),
			policy("admin", "governance", "update_level"),
			policy("admin", "governance", "delete_level"),
			policy("admin", "governance", "list_forbidden_words"),
			policy("admin", "governance", "create_forbidden_word"),
			policy("admin", "governance", "update_forbidden_word"),
			policy("admin", "governance", "delete_forbidden_word"),
			policy("admin", "governance", "list_email_logs"),
			policy("admin", "governance", "list_settings"),
			policy("admin", "governance", "update_setting"),
			policy("admin", "governance", "list_links"),
			policy("admin", "governance", "create_link"),
			policy("admin", "governance", "update_link"),
			policy("admin", "governance", "delete_link"),
			policy("admin", "governance", "list_tasks"),
			policy("admin", "governance", "create_task"),
			policy("admin", "governance", "update_task"),
			policy("admin", "governance", "delete_task"),
			policy("admin", "governance", "list_user_credits"),
			policy("admin", "governance", "adjust_user_credits"),
