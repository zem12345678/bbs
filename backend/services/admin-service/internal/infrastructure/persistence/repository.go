...
func defaultCasbinRules() []po.CasbinRule {
	return []po.CasbinRule{
		...
		policy("moderator", domain.ResourceGovernance, string(domain.ActionListChannels)),
		policy("moderator", domain.ResourceGovernance, string(domain.ActionFeatureChannel)),
		...
		policy("admin", domain.ResourceGovernance, string(domain.ActionArchiveChannel)),
		policy("admin", domain.ResourceGovernance, string(domain.ActionRestoreChannel)),
		...
		policy("admin", domain.ResourceGovernance, string(domain.ActionListAnnouncements)),
		policy("admin", domain.ResourceGovernance, string(domain.ActionCreateAnnouncement)),
		policy("admin", domain.ResourceGovernance, string(domain.ActionUpdateAnnouncement)),
		policy("admin", domain.ResourceGovernance, string(domain.ActionDeleteAnnouncement)),
