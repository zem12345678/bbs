...
import RiCommunityLine from "~icons/ri/community-line?raw";
import RiDiscussLine from "~icons/ri/discuss-line?raw";
...
import RiUserSearchLine from "~icons/ri/user-search-line?raw";
